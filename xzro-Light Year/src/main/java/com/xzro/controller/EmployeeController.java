...
//        }
    ...
    @PostMapping("/insert")
    protected RespBean insert(@RequestBody Employee employee) throws ServletException, IOException {
    ...
    @PostMapping("/update")
    protected RespBean update(@RequestBody Employee employee) throws ServletException, IOException {
        List<Employee> employees = employeeService.selectAll();
    ...
    @PostMapping("/delete")
    protected RespBean delete(Integer eid) throws ServletException, IOException {
    ...
    protected RespBean selectByEid(Integer eid) throws ServletException, IOException {
